...
public class AppDatabaseResourceProperties {
    ...
    private String domain = "database.nocode.cn";

    /** 数据库引擎名称。 */
    @NotBlank
    private String dbEngine = "SQLite";

    /** 代码生成时要求使用的后端运行时。 */
    @NotBlank
    private String backendRuntime = "go";

    /** SQL 执行确认策略。 */
    @NotBlank
    private String sqlExecutionPolicy = "ask_every_time";
}
