...
/** Runs generated Vue projects in the managed sandbox and grades browser runtime and visual evidence. */
@Slf4j
@Component
public class BrowserGenerationBenchmarkRuntimeGrader implements GenerationBenchmarkRuntimeGrader {
    ...
    public List<GenerationBenchmarkRuleResult> evaluate(GenerationBenchmarkRuntimeContext context) {
        ...
        try {
            ...
            startResult = devServerManager.startDevServer(app, context.userId());
    ...
    private void stopOwnedSession(long appId, DevServerStartResult startResult) {
        ...
        try {
            ...
            log.warn("Benchmark browser Dev Server cleanup failed, appId={}, error={}",
