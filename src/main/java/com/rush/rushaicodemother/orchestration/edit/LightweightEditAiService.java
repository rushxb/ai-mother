...
public class LightweightEditAiService {
    ...
    public EditResult generate(String userMessage, String projectContext) {
        return service().editCode(userMessage, projectContext);
    }
    ...
    public EditResult retryAfterPatchRejection(String userMessage,
        ...
        return service().editCode(retryMessage, projectContext);
    }
    ...
    private AiCodeEditService service() {
        return aiCodeEditServiceFactory.createAiCodeEditService();
    }
}
