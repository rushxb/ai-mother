...
class JacksonChatMessageJsonCodec implements ChatMessageJsonCodec {
    ...
    private static final ObjectMapper OBJECT_MAPPER = JsonMapper.builder()
            ...
            .addMixIn(ReasoningAiMessage.class, ReasoningAiMessageMixin.class)
    ...
    @JsonSubTypes({
            ...
            @JsonSubTypes.Type(value = ReasoningAiMessage.class, name = "AI"),
    ...
    @JsonDeserialize(builder = ReasoningAiMessage.Builder.class)
    private static abstract class ReasoningAiMessageMixin {
    }
