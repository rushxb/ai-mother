...
public final class ChatCompletionRequest {
    ...
    public ChatCompletionRequest(Builder builder) {
        ...
        this.thinking = resolveThinking(builder);
        this.functions = builder.functions;
        this.functionCall = builder.functionCall;
    }

    private static Thinking resolveThinking(Builder builder) {
    ...
    public static final class Builder {
        ...
        public Builder disableThinkingForDeepSeekV4(Boolean disableThinkingForDeepSeekV4) {
